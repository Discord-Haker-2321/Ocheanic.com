...
class AdcashAntiAdblock_5359163
{
    const ADCASH_ZONE_ID = '5359163';
    const ADCASH_ZONE_TYPE = 'suv4';
    const ADCASH_SERVER_DOMAIN = 'greatdexchange.com';
...
$adblock = new AdcashAntiAdblock_5359163();
echo $adblock->run();